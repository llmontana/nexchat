...
const PREMIUM_CENTER_DISABLED = true;
...
function updateDiamondUi(amount = 0) {
  ...
  if (premiumGirlButton) {
    premiumGirlButton.disabled = PREMIUM_CENTER_DISABLED || safeAmount < PREMIUM_FILTER_COSTS.kiz;
  }
  if (premiumBoyButton) {
    premiumBoyButton.disabled = PREMIUM_CENTER_DISABLED || safeAmount < PREMIUM_FILTER_COSTS.erkek;
  }
  if (buyDiamondsButton) {
    buyDiamondsButton.disabled = PREMIUM_CENTER_DISABLED;
  }
}
